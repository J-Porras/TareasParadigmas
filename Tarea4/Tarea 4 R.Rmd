...
porcen.vector(c(3, 3, 3, 3 ,3 ,3 ,10 ,10,10 ,10),3)
porcen.vector(c(2, 2, 3, 4 ,5, 6),1)
porcen.vector(c(1, 2, 3, 4 ,5, 6),4)
...
pega.tres.listas(c(1,2),c(3,4),c(5,6))
pega.tres.listas(c(1,2,3),c(),c(5,6))
pega.tres.listas(c(),c(8,7,6),c(5,6))
...
output.complejo(resta.compleja(num.complejo(1,5),num.complejo(8,7)))
output.complejo(resta.compleja(num.complejo(10,-9),num.complejo(4,8)))
output.complejo(resta.compleja(num.complejo(-3,8),num.complejo(15,-7)))
...
output.complejo(multi.compleja(num.complejo(1,5),num.complejo(8,7)))
output.complejo(multi.compleja(num.complejo(10,-9),num.complejo(4,8)))
output.complejo(multi.compleja(num.complejo(-3,8),num.complejo(15,-7)))


conjugado.complejo<-function(n1){
  return(num.complejo(parte.real(n1),(-1 * parte.compleja(n1))))
}
output.complejo(conjugado.complejo(num.complejo(1,5)))
output.complejo(conjugado.complejo(num.complejo(8,4)))
output.complejo(conjugado.complejo(num.complejo(-1,10)))
...
divisibles(c(2,3,4,5,6,7,8,9),3)
divisibles(c(2,3,4,5,6,7,8,9),5)
...
resta.listas(c(7, 1, 4, 3, 2, 4, 2, 4, 6),c(7,1,4,3,6))
resta.listas(c(7, 1, 4, 3, 2, 4, 2, 4, 6),c())
...
crea.pares(c(1,4,3),c(1,4,-1))
#No acepta listas de tamaño distinto
crea.pares(c(1,4,3,1),c(1,4,-1))
